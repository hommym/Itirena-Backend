...
import { couseSlipUploadController, timeTableInfoSaveController, timeTableUploadController, courseSlipInfoSaveController } from "../controllers/courseDataControllers";
